...
namespace WebApi2_Estudantes.Models
{
    public class EstudanteRepositorio : IEstudanteRepositorio
    {
        ...
        {
            Add(new Estudante { nome = "Alexandre", id = 1, genero = "Masculino", idade = 55 });
            Add(new Estudante { nome = "Jefferson", id = 2, genero = "Masculino", idade = 24 });
            Add(new Estudante { nome = "Patrícia", id = 3, genero = "Feminino", idade = 35 });
        ...
        public bool Add(Estudante estudante)
        {
            ...
            int index = estudantes.FindIndex(e => e.id == estudante.id);
            if (index == -1)
            {
